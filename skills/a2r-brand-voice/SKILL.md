---
name: a2r-brand-voice
description: >
  A2R brand voice and writing style guide. Provides tone of voice rules, personality pillars,
  language conventions (English and Spanish), CTA patterns, competitor positioning stance,
  and contextual tone modulation. Use when writing, reviewing, or editing any A2R copy —
  website text, sales proposals, social media posts, blog content, email campaigns,
  keynote scripts, product descriptions, or any customer-facing communication. Also use
  when localizing A2R content to Spanish or when checking copy for brand voice compliance.
---
